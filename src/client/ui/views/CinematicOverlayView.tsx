...
export class CinematicOverlayView {
	...
	constructor(parentContainer?: Instance) {
		...
		// Top Letterbox Bar: Posisi aktif default diam di tempat
		this.topBar = new Instance("Frame");
		this.topBar.Name = "TopBar";
		this.topBar.Size = new UDim2(1, 0, 0.125, 0);
		this.topBar.Position = new UDim2(0, 0, 0, 0);
		...
		// Bottom Letterbox Bar: Posisi aktif default diam di tempat
		this.bottomBar = new Instance("Frame");
		this.bottomBar.Name = "BottomBar";
		this.bottomBar.AnchorPoint = new Vector2(0, 1);
		this.bottomBar.Size = new UDim2(1, 0, 0.125, 0);
		this.bottomBar.Position = new UDim2(0, 0, 1, 0);
